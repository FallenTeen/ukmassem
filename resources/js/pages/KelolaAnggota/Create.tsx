...
import type { AnggotaForm, Divisi, StatusAnggota } from '@/types/anggota';
...
export default function Create() {
    const { data, setData, post, processing, errors, reset } = useForm<AnggotaForm>({
        NIM: '',
        nomor_anggota: '',
        tanggal_lahir: '',
        nama_panggilan: [''],
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4">
                ...
                <div className="mx-auto max-w-3xl rounded-lg border bg-background p-4 md:p-6">
                    <h1 className="mb-4 text-lg font-semibold">Tambah Anggota</h1>
